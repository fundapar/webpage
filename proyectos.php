					      ...
					      <ul class="nav navbar-nav">
					        	...
					        	<li class="dropdown"><a href="/">Inicio</a></li>
								 ...
								 <li class="dropdown">
									...
									<li class="dropdown"><a tabindex="0" href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" aria-expanded="false" data-submenu>Educación e Investigación<span class="caret"></span></a>
...
<?php echo utf8_encode("<h3>Proyectos</h3>");?>
