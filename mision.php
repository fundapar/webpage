					           ...
					           <li class="dropdown"><a href="/">Inicio</a></li>
								 ...
								 <li class="active">
							          ...
							          <ul class="dropdown-menu">
							            ...
							            <li class="active"><a href="mision.php">Misi&oacute;n</a></li>
...
<div class="panel-body">
		 		<h3>Misión</h3>
				 <p style="text-align: justify;">La Fundación Cultural Ambiental y Deportiva Cartagena con Parques FUNDAPAR es una
				 					 			entidad sin ánimo de lucro que ofrece a nivel nacional una mano amiga para ayudar con
 												transparencia y efectividad a los más necesitados, mediante la ejecución de programas de
												educación con calidad en todos los niveles y proporcionando asistencia humanitaria de
												manera oportuna para el mejoramiento de las condiciones de vida de la población
												vulnerable, en el área cultural, convivencia, valores, recreación y acompañamiento
												educativo.</p>
