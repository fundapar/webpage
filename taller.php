	<?php require_once 'recursos/partespag/head.php'; ?>ript src="https://use.fontawesome.com/9a5740dd20.js"></script>
									...
									<li class="dropdown">
							         ...
							         <li class="active">
							          ...
							          <ul class="dropdown-menu">
							           	...
							           	<li class="active"><a href="formacion.php">Formación</a></li>
...
<?php echo utf8_encode("<h3>Talleres</h3>");?>
				 <p><img src="img/images-galeria/fotos3.png" width="640" height="480" alt="Equipo 2016" style="display: block; margin-left: auto; margin-right: auto;" class="carusel2  img-responsive "></p>
