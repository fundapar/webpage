					        	...
					        	<li class="dropdown"><a href="/">Inicio</a></li>
								 ...
								 <li class="dropdown">
							        ...
							        <li class="active">
							          ...
							          <ul class="dropdown-menu">
							           	<li ><a href="proyectos.php">Proyectos</a></li>
							           	<li class="active"><a href="conservacion.php">Conservación de Parques</a></li>
							           	<li ><a href="campanas.php">Campañas vigentes</a></li>
							          </ul>
							        </li>
...
<h3>Conservación de Parques</h3>
				 <p><img src="img/images-galeria/foto4.png" width="640" height="480" alt="Equipo 2016" style="display: block; margin-left: auto; margin-right: auto;" class="carusel2  img-responsive "></p>
				 <p style="text-align: justify;">La Fundación Cultural Ambiental y Deportiva Cartagena con Parques FUNDAPAR serÃ¡ una
												entidad reconocida y posicionada a nivel nacional, por una destacada gestión de carÃ¡cter
												social y humanitario, que generarÃ¡ altos niveles de confianza sustentada en las acciones
